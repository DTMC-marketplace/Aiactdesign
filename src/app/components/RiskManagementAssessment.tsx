...
interface RiskManagementAssessmentProps {
  taskName: string;
  article: string;
  onBack: () => void;
}

export function RiskManagementAssessment({
  taskName,
  article,
  onBack,
}: RiskManagementAssessmentProps) {
  return (
    <div className="flex-1 flex flex-col h-screen overflow-hidden bg-[#FAFBFC]">
      ...
      <div className="bg-white border-b border-[#F0F1F2] px-8 py-6">
        ...
        <p className="font-['Montserrat',sans-serif] font-normal text-base text-[#565F6C] mt-2">
          Systematic identification, analysis, and management of risks in AI systems.
        </p>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto px-8 py-8">
          ...
          <div className="bg-white rounded-lg border border-[#F0F1F2] shadow-sm p-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              {/* AI Agent Scan Card */}
              <button className="relative bg-white border-2 border-[#E5E7EB] rounded-lg p-6 text-left hover:border-[#F13D30] hover:shadow-lg transition-all group">
